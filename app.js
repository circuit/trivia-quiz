...
const isInvalidQuiz = quiz => !quiz || quiz.some(q => !mapIndexToAnswers(q.answer) || !q.question || !q.question.length || !q.answers || q.answers.length !== 4 || !q.answers.every(a => !!a.length))
